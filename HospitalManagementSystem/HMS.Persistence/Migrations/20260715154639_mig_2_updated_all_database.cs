...
{
    /// <inheritdoc />
    public partial class mig_2_updated_all_database : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BedNumber = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: false),
                    Status = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PatientId = table.Column<Guid>(type: "uuid", nullable: false),
                    DoctorId = table.Column<Guid>(type: "uuid", nullable: false),
                    FollowUpInstructions = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DischargeSummaries_Doctors_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "Doctors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DischargeSummaries_Visits_VisitId",
                        column: x => x.VisitId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NormalRange = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    Status = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LabResults_AspNetUsers_OrderedById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DischargeSummaries_DoctorId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DischargeSummaries_VisitId",
                table: "DischargeSummaries",
                column: "VisitId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DoctorSchedule_DoctorId_Day",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Visits_PatientId_AdmissionDate",
                table: "Visits",
                columns: new[] { "PatientId", "AdmissionDate" });
        }
